...
const StudentLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.error('Invalid credentials. Try: student@example.com / student123');
    } finally {
      setLoading(false);
    }
  };
      ...
      >
        ...
        <div className="border-4 border-foreground bg-card p-8 shadow-xl">
          ...
          <p className="text-center text-muted-foreground font-mono text-sm mb-8">
            Access your exam results and OMR sheets
          </p>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <Label htmlFor="email" className="font-mono">EMAIL / ROLL NUMBER</Label>
              <Input
                id="email"
                type="text"
